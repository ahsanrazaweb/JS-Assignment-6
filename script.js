    ...
    if ( roundvalue == '') {
        Toastify({
            ...
            style: {
              ...
              background: " linear-gradient(205deg, hsl(240deg 100% 20%) 0%,  hsl(262deg 100% 24%) 22%,  hsl(284deg 100% 27%) 33%,  hsl(306deg 100% 31%) 42%,hsl(327deg 100% 35%) 50%, hsl(349deg 100% 39%) 58%,hsl(11deg 100% 43%) 67%, hsl(33deg 100% 46%) 78%,    hsl(55deg 100% 50%) 100% )",
            }
          }).showToast();
...
function generatePassword(){
    let paswrd = "";
    let stringValue = "ABCDEFGHIJKLMNOPQRSTUVXYZabcdefghijklmnopqrstuvxyz@#$&*"
     for( i= 1; i<=8; i++){
